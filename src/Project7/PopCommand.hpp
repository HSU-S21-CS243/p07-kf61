...
public:
	...
	virtual string ToAsm()
	{
		...
		case Segment::Local:
			//@ segment
			result << "@LCL" << "\t\t//begin POP LOCAL command" << endl;
			//get segment start
			result << "D=M" << endl;
			...
			result << "A=M" << endl;
			result << "D=M" << endl;
			//store value at top of stack appropriate address
			result << "@LCL" << endl;
			result << "A=M" << endl;
			result << "M=D" << "\t\t//end POP LOCAL command" << endl;
		...
		case Segment::Static:
			//@ segment
			result << "@R16" << "\t\t//begin POP STATIC command" << endl;
			//get segment start
			result << "D=A" << endl;
			//segment + offset  = address
			result << "@" << arg1 << endl;
